...
PROPS=$(DIR_BIN)\ForwardEditGlobal.properties $(DIR_BIN)\abbrev.properties $(LEXPROPS)
...
$(DIR_BIN)\ForwardEditGlobal.properties: ..\src\ForwardEditGlobal.properties
	copy ..\src\ForwardEditGlobal.properties $@
...
FERes.res: ForwardEdit.rc ..\src\SciTE.h ForwardEdit.exe.manifest
	$(RC) $(INCLUDEDIRS) -fo$@ ForwardEdit.rc

ForwardEditRes.res: ForwardEdit.rc ..\src\SciTE.h ForwardEdit.exe.manifest
	$(RC) $(INCLUDEDIRS) -dSTATIC_BUILD -fo$@ ForwardEdit.rc

$(PROG): $(OBJS) ForwardEdit.res
	$(LD) $(LDFLAGS) -OUT:$@ $** $(LIBS)

$(PROGSTATIC): $(OBJSSTATIC) $(LEXLIB) ForwardEdit.res
	$(LD) $(LDFLAGS) -OUT:$@ $** $(LIBS)
